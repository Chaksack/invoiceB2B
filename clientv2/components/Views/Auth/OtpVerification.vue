  ...
  <div class="min-h-screen flex flex-col lg:flex-row font-inter">
    ...
    <div class="bg-white p-4 sm:p-6 md:p-8 lg:p-12 w-full lg:w-1/2 flex flex-col justify-between">
      <div class="flex flex-col items-center w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto p-4 sm:p-6 md:p-8 my-auto">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 text-center">Verification Code</h2>
        <p class="text-gray-600 mb-6 sm:mb-8 text-center text-sm sm:text-base">
          We've sent a verification code to <span class="font-medium">your.email@example.com</span>
        </p>
        ...
        <div class="w-full mb-6 sm:mb-8">
          ...
          <div class="flex justify-between gap-2 sm:gap-3">
            <Input type="text" maxlength="1" class="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-bold rounded-lg border border-gray-300 focus:ring-primary focus:border-primary shadow-sm" />
            <Input type="text" maxlength="1" class="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-bold rounded-lg border border-gray-300 focus:ring-primary focus:border-primary shadow-sm" />
            <Input type="text" maxlength="1" class="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-bold rounded-lg border border-gray-300 focus:ring-primary focus:border-primary shadow-sm" />
            <Input type="text" maxlength="1" class="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-bold rounded-lg border border-gray-300 focus:ring-primary focus:border-primary shadow-sm" />
            <Input type="text" maxlength="1" class="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-bold rounded-lg border border-gray-300 focus:ring-primary focus:border-primary shadow-sm" />
        ...
        <div class="text-center">
          ...
          <button class="text-xs sm:text-sm text-primary hover:underline font-medium">
            Resend Code <span class="text-gray-500">(in 30s)</span>
          </button>
        </div>
