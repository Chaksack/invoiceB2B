...
const users = ref([
  {
    id: '1',
    invoice: '123456789',
    manufacturor: 'Tech Innovators Ltd.',
  ...
  },
  {
    id: '2',
    invoice: '123456789',
    manufacturor: 'Global Marketing Solutions',
  ...
  },
  {
    id: '3',
    invoice: '123456789',
    manufacturor: 'Green Energy Corp.',
  ...
  },
  {
    id: '4',
    invoice: '123456789',
    manufacturor: 'Food Distribution Network',
    ...
    <main class="flex flex-col items-start gap-4 p-4 sm:px-6 sm:py-2 md:gap-8">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink href="/admin/invoices/pending">Pending Invoice</BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <div class="w-full overflow-x-auto">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4">
          <input
              ...
              class="w-full sm:w-96 py-1 px-2 bg-transparent  rounded-full sm:mr-2 focus:outline-none focus:ring-2 focus:ring-black shadow-lg"
          ...
          <Dialog>
            <DialogTrigger as-child>
              <Button
                  variant="outline"
                  size="sm"
                  class="h-7 gap-2 bg-black font-semibold text-sm text-white hover:bg-gray-500 hover:text-white rounded-lg px-3"
              >
            ...
            >
              <DialogHeader class="pb-4">
                <DialogTitle class="">New Invoice Application</DialogTitle>
                <DialogDescription>
            ...
            <Table class="w-full min-w-[768px]">
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Manufacturor</TableHead>
                  ...
                  <TableCell>
                    <Avatar class="relative bg-black overflow-visible">
                      ...
                      <AvatarFallback class="bg-black text-white">
                        {{ user.manufacturor.substring(0, 2).toUpperCase() }}
                      </AvatarFallback>
                    </Avatar>
                  </TableCell>
                  <TableCell>{{ user.manufacturor }}</TableCell>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger as-child>
                          <NuxtLink to="/invoice/view">
                            <button class="bg-black  px-2 py-1 text-white rounded-lg"><Eye class="w-4"/></button>
                          </NuxtLink>
                        </TooltipTrigger>
                        <TooltipContent>
                          <p>View Invoice</p>
