    ...
    <section class="">
      <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <div class="mt-4 md:mt-0">
          <p class="inline-flex mb-2 items-center text-black bg-gray-200 font-medium rounded-full text-sm px-5 py-2 text-center ">
            Worry Less, Easy Funding
          </p>
          <h2 class="mb-4 text-4xl tracking-tight font-black text-black">Finance Made Simple For</h2>
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold bg-gradient-to-r from-gray-700 via-gray-400 to-gray-400 bg-clip-text text-transparent">Entrepreneurs <span class="text-black">& </span> SME.</h2>
          <p class="mb-6 font-medium text-gray-500 md:text-lg ">We are building a digital B2B Marketplace to support growth of Ghanaian MSMEs.</p>
          <a href="#" class="inline-flex items-center text-black border border-gray-900 focus:ring-4 focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center ">
...
<div class="bg-gray-100 py-6">
    <section class="flex items-center justify-center w-full">
      <div class="max-w-screen-xl px-4 py-2 mx-auto lg:gap-2 xl:gap-0 text-center">
        <p class="inline-flex mb-2 items-center text-black bg-gray-200 font-medium rounded-full text-sm px-5 py-2 text-center ">
          Why Choose Us
        </p>
        <h2 class="mb-4 text-4xl tracking-tight text-balance font-bold text-black">
          Explore
          <span class="bg-gradient-to-r from-gray-700 via-gray-400 to-gray-400 bg-clip-text text-transparent">Our App's </span> Best Features.</h2>
      </div>
    </section>
...
Find Your Answers Here
          ...
          <h2 class="mb-4 text-4xl tracking-tight font-black text-black">Frequently <span class="mb-4 text-4xl tracking-tight font-extrabold text-gray-500 ">asked</span> questions</h2>
          <p class="mb-6 font-medium text-gray-500 md:text-lg ">If you still have questions, feel free to contact us anytime!</p>
          <a href="#" class="inline-flex items-center text-white shadow-lg bg-black font-medium rounded-full text-sm px-5 py-2.5 text-center ">
            Get Started For Free
            <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </a>
        </div>
        <Accordion type="single" class="w-full " collapsible :default-value="defaultValue">
          <AccordionItem v-for="item in accordionItems" :key="item.value" :value="item.value" class="bg-gray-100 px-4 rounded-lg mb-2">
