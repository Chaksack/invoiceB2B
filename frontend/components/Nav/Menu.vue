<template>
  <header
      ...
      :class="[
      isScrolled ? 'bg-white backdrop-blur-lg' : 'bg-white',
      'sticky top-0 z-50',
    ]"
  >    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      <NuxtLink to="/" class="-m-1.5 p-1.5">
        <h2 class="text-2xl font-bold">InvoiceFnd</h2>
      </NuxtLink>
    </div>
    ...
    <NavigationMenu>
      <NavigationMenuList>
          ...
          <NavigationMenuItem class="px-2 text-md font-semibold" >Home
          </NavigationMenuItem>

          <NavigationMenuItem class="px-2 text-md font-semibold" >Features
          </NavigationMenuItem>
        <NavigationMenuItem class="px-2 text-md font-semibold" >FAQs
        </NavigationMenuItem>
          <NavigationMenuItem class="px-2 text-md font-semibold" >Support
          </NavigationMenuItem>
    ...
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
      <NuxtLink to="/login" class="text-sm/6 mr-2 font-semibold border border-gray-500 px-4 py-1 rounded-full text-black">
        Log in
      </NuxtLink>
      <NuxtLink to="/register" class="text-sm/6 font-semibold shadow-lg bg-black px-4 py-1 rounded-full text-white">
        Create an account
      </NuxtLink>
    </div>
  </nav>
